...
```bibtex
@software{task_mining_classification,
  title={Task Classification with Multimodal Event Logs},
  author={Your Name},
  year={2024},
  url={https://github.com/your-repo/task_mining_classification}
}
```
...
- Review the example notebook in `data_exploration.ipynb`